...
namespace DG.Tweening
{
    ...
    /// <summary>
    /// Methods that extend TMP_Text objectsToDeactivate and allow to directly create and control tweens from their instances.
    /// </summary>
    ...
    /// <summary>
    /// Wrapper for <see cref="TMP_Text"/> objectsToDeactivate that enables per-character tweening
